...
| --- | --- | --- |
| [3beans-release-unstable-2026-02-26](https://github.com/Hydr8gon/3Beans) | \_3beans | A low-level 3DS emulator (maybe) |
...
| [azahar-2125.0-alpha4-unstable-2026-03-07](https://github.com/azahar-emu/azahar) | azahar-master | Open-source 3DS emulator project based on Citra (master branch) |
...
| [retro-aim-server-0.22.0](https://github.com/mk6i/retro-aim-server) | retro-aim-server | Self-hostable instant messaging server compatible with classic AIM and ICQ clients |
...
| [vacuumtube-1.5.8](https://github.com/shy1132/VacuumTube) | vacuumtube | YouTube Leanback on the desktop, with enhancements |
| [vanilla-continuous-unstable-2026-02-22](https://github.com/vanilla-wiiu/vanilla) | vanilla | A software clone of the Wii U GamePad for Linux |
