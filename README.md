...
| --- | --- | --- |
| [3beans-release-unstable-2026-08-05](https://github.com/Hydr8gon/3Beans) | \_3beans | A low-level 3DS emulator (maybe) |
...
| [azahar-2126.1-rc3-unstable-2026-09-04](https://github.com/azahar-emu/azahar) | azahar-master | Open-source 3DS emulator project based on Citra (master branch) |
...
| [evi-original-v9.1.0-unstable-2026-09-03](https://codeberg.org/evi-editor/evi) | evi | EVi, a hard-fork of Vim v9.1.0 (Jan 2024) before AI was used in the project |
| [evi-full-original-v9.1.0-unstable-2026-09-03](https://codeberg.org/evi-editor/evi) | evi-full | EVi, a hard-fork of Vim v9.1.0 (Jan 2024) before AI was used in the project |
...
| [vanilla-continuous-unstable-2026-09-03](https://github.com/vanilla-wiiu/vanilla) | vanilla | A software clone of the Wii U GamePad for Linux |
| [wfs-tools-1.2.3-unstable-2025-03-19](https://github.com/koolkdev/wfs-tools) | wfs-tools | WFS (WiiU File System) Tools |
| [wheelwizard-2.5.3](https://github.com/TeamWheelWizard/WheelWizard) | wheelwizard | Retro Rewind Launcher |
...
| [yt-dlp-2026.08.19-unstable-2026-08-30](https://github.com/yt-dlp/yt-dlp/) | yt-dlp-master | Feature-rich command-line audio/video downloader (master branch) |
